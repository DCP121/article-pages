...
document.addEventListener("DOMContentLoaded", function () {
              ...
              loadScript("https://apis.google.com/js/api.js", function () {
                ...
                $(document).ready(function () {
                  ...
                  const commentlistapi = async (apiFlag) => {
                    ...
                    $.ajax({
                      url: `https://9900-137-184-19-129.ngrok-free.app/api/v1/artical-page/articalPage?pageId=${document.getElementsByName("page_id")[0].id
                  ...
                  function processData(xyz, apiFlag) {
                    ...
                    const $Accountpending = $("<div>").append(
                      ...
                      $("<span>")
                        ...
                        .click(function () {
                          ...
                          fetch(
                            `https://9900-137-184-19-129.ngrok-free.app/api/v1/user/resend-otp`,
                            {
                              method: "POST",
                              headers: headers,
                              body: JSON.stringify({
                      ...
                      if (commentlistingdata?.data?.pageData?.mustLogin) {
                        ...
                        if (!token) {
                          ...
                          if (originalComment === "") {
                            ...
                            const apiUrl = `https://9900-137-184-19-129.ngrok-free.app/api/v1/comments/addComments/${document.getElementsByName("page_id")[0].id
                              }`; // Example URL
                        ...
                        if (originalComment === "") {
                          ...
                          const apiUrl = `https://9900-137-184-19-129.ngrok-free.app/api/v1/comments/addComments/${document.getElementsByName("page_id")[0].id}`; // Example URL
                    ...
                    commentlistingdata.data.allCommentsData.forEach(
                      (dataItem) => {
                        ...
                        $likeIcon.click(async function () {
                          ...
                          fetch(
                            `https://9900-137-184-19-129.ngrok-free.app/api/v1/comments/updateLike?commentId=${dataItem._id}`,
                            {
                              method: "POST",
                              headers: headers,
                              body: JSON.stringify({
                        ...
                        dataItem?.replyComments?.forEach((item) => {
                          if (item) {
                            ...
                            fetch(
                              `https://9900-137-184-19-129.ngrok-free.app/api/v1/comments/updateLike?commentId=${item?.id}`,
                              {
                                method: "POST",
                                headers: headers,
                                body: JSON.stringify({
                          ...
                          if (commentlistingdata?.data?.pageData?.mustLogin) {
                            ...
                            if (!token) {
                              ...
                              if (commentReplay === "") {
                                ...
                                const apiUrl = `https://9900-137-184-19-129.ngrok-free.app/api/v1/comments/addCommentsReplay/${dataItem?._id}`; // Example URL
                    ...
                    window.handleCredentialResponse = (response) => {
                      if (response.credential) {
                        ...
                        fetch(
                          "https://9900-137-184-19-129.ngrok-free.app/api/v1/user/google-sign-in",
                          {
                            method: "POST",
                            headers: {
  ...
  `;
                    ...
                    async function handleLogin() {
                      ...
                      try {
                        const response = await axios.post(
                          "https://9900-137-184-19-129.ngrok-free.app/api/v1/user/login-article-page",
                          payload,
                          {
                            headers: {
                              "Content-Type": "application/json",
                    ...
                    async function sendForgotPasswordRequest() {
                      ...
                      try {
                        const response = await axios.post(
                          "https://9900-137-184-19-129.ngrok-free.app/api/v1/user/forgot-password-article-page",
                          ForgotPassPayload,
                          {
                            headers: {
                              "Content-Type": "application/json",
                    ...
                    async function handleOTPConfirmation() {
                      ...
                      try {
                        const response = await axios.post(
                          "https://9900-137-184-19-129.ngrok-free.app/api/v1/user/verify-otp-for-article",
                    ...
                    async function handleResetSubmit() {
                      ...
                      try {
                        const response = await axios.post(
                          "https://9900-137-184-19-129.ngrok-free.app/api/v1/user/reset-password-article-page",
                          ResetPassVal,
                          {
                            headers: {
                              "Content-Type": "application/json",
                    ...
                    async function handleRegistration() {
                      ...
                      try {
                        const response = await axios.post(
                          "https://9900-137-184-19-129.ngrok-free.app/api/v1/user/register-article-page",
                          payload,
                          {
                            headers: {
                              "Content-Type": "application/json",
