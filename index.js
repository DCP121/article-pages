                ...
                $(document).ready(function () {
                    ...
                    function processData(xyz) {
                        ...
                        async function handleLogin() {
                            ...
                            // Send a POST request to the login API
                            try {
                                const response = await axios('https://a28e-137-184-19-129.ngrok-free.app/api/v1/user/login-article-page', {
                                    method: 'POST',
                                    headers: {
                                        'Content-Type': 'application/json'
                                    },
                        ...
                        const $ForgotPassSubmit = $('<button>').text('Submit').css({
                            ...
                            try {
                                const response = await axios.post('https://a28e-137-184-19-129.ngrok-free.app/api/v1/user/forgot-password-article-page', otpConfirmationPayload, {
                                    headers: {
                                        'Content-Type': 'application/json',
                                    },
                                });
                        ...
                        function handleOTPConfirmation() {
                            ...
                            fetch('https://a28e-137-184-19-129.ngrok-free.app/api/v1/user/verify-otp-for-article', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                },
                        ...
                        async function handleResetSubmit() {
                            ...
                            // Send a POST request to the OTP confirmation API
                            try {
                                const response = await axios('https://a28e-137-184-19-129.ngrok-free.app/api/v1/user/reset-password-article-page', {
                                    method: 'POST',
                                    headers: {
                                        'Content-Type': 'application/json',
                                    },
                        ...
                        async function handleRegistration() {
                            ...
                            try {
                                const response = await fetch('https://a28e-137-184-19-129.ngrok-free.app/api/v1/user/register-article-page', {
                                    method: 'POST',
                                    headers: {
                                        'Content-Type': 'application/json'
                                    },
