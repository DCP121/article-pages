        ...
        loadScript("https://cdn.datatables.net/1.11.5/js/jquery.dataTables.min.js", function () {
            ...
            loadScript("https://apis.google.com/js/api.js", function () {
                ...
                $(document).ready(function () {
                    ...
                    $.ajax({
                        url: 'https://3902-137-184-19-129.ngrok-free.app/api/v1/artical-page/articalPage?pageId=65098ac7dfc16014091b766f&userId=650be9d87b17d73c9b2c94ae', // Replace with your API endpoint
                        method: 'POST',
                        dataType: 'json',
                        headers: {
                    ...
                    function processData(xyz) {
                        ...
                        const $ForgotPassSubmit = $('<button>').text('Submit').css({
                            ...
                            try {
                                const response = await axios.post('https://3902-137-184-19-129.ngrok-free.app/api/v1/user/forgot-password-article-page', otpConfirmationPayload, {
                                    headers: {
                                        'Content-Type': 'application/json',
                                    },
                                });
                        ...
                        // Create the registration button
                        const $registerButton = $('<button>').text('Create account').css({
                            'margin-top': '10px',
                            'width': '100%',
                            'padding': '5px 10px',
                            'background': '#E8505B',
                        ...
                        function handleOTPConfirmation() {
                            ...
                            fetch('https://3902-137-184-19-129.ngrok-free.app/api/v1/user/verify-otp-for-article', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                },
                        ...
                        async function handleResetSubmit() {
                            ...
                            // Send a POST request to the OTP confirmation API
                            try {
                                const response = await axios('https://3902-137-184-19-129.ngrok-free.app/api/v1/user/reset-password-article-page', {
                                    method: 'POST',
                                    headers: {
                                        'Content-Type': 'application/json',
                                    },
                        ...
                        async function handleRegistration() {
                            ...
                            try {
                                const response = await fetch('https://3902-137-184-19-129.ngrok-free.app/api/v1/user/register-article-page', {
                                    method: 'POST',
                                    headers: {
                                        'Content-Type': 'application/json'
                                    },
